...
- **差異化定價**: 支持性別和身體部位的差異化定價
- **套餐服務**: 支持多個服務組合成套餐
- **限時優惠**: 支持設置限時優惠價格和閃購活動
- **自定義選項**: 支持為服務添加自定義選項和附加服務
...
### Q: 如何設置性別差異化定價？
A: 在服務編輯頁面的「差異化定價」區域，可以為不同性別設置不同的價格。

### Q: 如何創建套餐服務？
A: 選擇服務類型為「套餐服務」，然後在套餐內容區域添加需要包含的服務項目，可以設置每個項目的時長和價格。

### Q: 如何設置限時優惠？
A: 在服務編輯頁面勾選「限時優惠」選項，設置優惠時間段、優惠價格或折扣比例，並可添加優惠說明。
